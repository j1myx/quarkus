...
public class ResourceProperties {
    ...
    public ResourceProperties(boolean exposed, String path, boolean paged, boolean hal, String halCollectionName,
            String[] rolesAllowed, Class<?>[] jsonView, Collection<AnnotationInstance> classAnnotations,
    ...
    public Class<?>[] getJsonView(String methodName) {
        if (methodProperties.containsKey(methodName)) {
            return methodProperties.get(methodName).getJsonView();
        }
